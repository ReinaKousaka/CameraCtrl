...
def get_args():
    ...
    parser.add_argument('--lora_ckpt_path', type=str, default='/home/wei/PycharmProjects/cameractrl/weights/v3_sd15_adapter.ckpt')
    parser.add_argument('--unet_ckpt_path', type=str, default='/home/wei/PycharmProjects/cameractrl/weights/stable-diffusion-v1-5', help='root path of the sd1.5 model')
    parser.add_argument('--save_path', type=str, default='/home/wei/PycharmProjects/cameractrl/weights/unet_webvidlora_v3', help='args.unet_ckpt_path + a new subfolder name')
    parser.add_argument('--unet_config_path', type=str, default='/home/wei/PycharmProjects/cameractrl/weights/stable-diffusion-v1-5/unet/config.json', help='path to unet config, in the `unet` subfolder of args.unet_ckpt_path')
