...
def main(name: str,
    ...
    *_, config = inspect.getargvalues(inspect.currentframe())
    ...
    attn3_trainable_params = [v for k, v in unet.named_parameters() if v.requires_grad and 'attn3' in k]
    attn3_trainable_params_names = [k for k, v in unet.named_parameters() if v.requires_grad and 'attn3' in k]
