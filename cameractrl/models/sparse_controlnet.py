...
from .unet_blocks_sparse import (
...
from .resnet_sparse import InflatedConv3d
...
class SparseControlNetModel(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        for i, down_block_type in enumerate(down_block_types):
            ...
            # TODO: self.down_blocks should be cameractrl
            ...
            #     # TODO: may add use_inflated_groupnorm in the future
    ...
    def from_unet(
        cls,
        unet: UNet2DConditionModel,         # TODO: check type?
        controlnet_conditioning_channel_order: str = "rgb",
        conditioning_embedding_out_channels: Optional[Tuple[int]] = (16, 32, 96, 256),
    ...
    def forward(
        ...
        controlnet_cond: torch.FloatTensor,     # 4, t, w, h         t = 0 is first frame   cond
        conditioning_mask: Optional[torch.FloatTensor] = None,  # 1, t, w, h
