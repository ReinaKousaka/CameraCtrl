...
class PoseAdaptor(nn.Module):
    ...
    def forward(self, noisy_latents, timesteps, encoder_hidden_states, pose_embedding, attention_mask_epipolar,camera_embeddings):
        ...
        noise_pred = self.unet(noisy_latents,
                               ...
                               camera_embeddings = camera_embeddings,).sample
        return noise_pred
