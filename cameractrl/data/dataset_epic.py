...
class EpicKitchen(Dataset):
    def __init__(self,
        ...
        print(f'EpicKitchen: there are {len(self.datalist)} videos with narrations, and {4 * len(self.datalist_no_narration)} videos without narrations')
    ...
    def __getitem__(self, index):
        while True:
            try:
                ...
                sample_stride = self.sample_stride + random.randint(-2, 2)
        ...
        return {
            ...
            'frame_info': (video_id, start_frame, indices[0])
        }