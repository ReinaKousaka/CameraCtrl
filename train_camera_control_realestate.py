...
def main(name: str,
    ...
    *_, config = inspect.getargvalues(inspect.currentframe())
    ...
    attn3_trainable_params = [v for k, v in unet.named_parameters() if v.requires_grad and ('attn3' in k or 'attn2' in k or 'cc_projection' in k)]
    attn3_trainable_params_names = [k for k, v in unet.named_parameters() if v.requires_grad and ('attn3' in k or 'attn2' in k or 'cc_projection' in k)]
    ...
    for epoch in range(first_epoch, num_train_epochs):
        ...
        for batch_idx, batch in enumerate(train_dataloader):
            ...
            # print(encoder_hidden_states.shape, image_hidden_states.shape)
            ...
            camera_embeddings = batch['camera_embeddings'].to(
                            local_rank, non_blocking=True)
            ...
            with torch.cuda.amp.autocast(enabled=mixed_precision_training):
                model_pred = pose_adaptor(noisy_latents,
                                          ...
                                          attention_mask_epipolar=attn_masks,
            ...
            if is_main_process and (
                ...
                for idx, validation_batch in enumerate(validation_data_iter):
                    ...
                    sample = validation_pipeline(
                        ...
                        test_camera_embeddings=test_camera_embeddings,
                    ).videos[0]  # [3 f h w]
